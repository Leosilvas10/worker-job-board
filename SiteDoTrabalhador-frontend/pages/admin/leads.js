              ...
              <div className="mt-2 text-sm text-blue-700">
                ...
                <ul className="mt-2 ml-4 list-disc">
                  ...
                  <li><strong>Exportar:</strong> Dados para análise externa (CSV)</li>
                      ...
                      <div className="text-sm text-govgray-700 whitespace-pre-wrap">
                        {selectedLead.observacoes || selectedLead.mensagem || 'N/A'}
                      </div>
                    </div>
                  )}
                  ...
                  {/* Dados de Controle */}
                  <div>
                    <h3 className="font-semibold text-govgray-800 mb-2">ℹ️ Informações do Sistema</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        <span className="text-sm text-govgray-600">Status:</span>
                        <div>{getStatusBadge(selectedLead.status || 'novo')}</div>
                      </div>
                      <div>
                        <span className="text-sm text-govgray-600">Fonte:</span>
                        <div className="font-medium">{selectedLead.fonte || 'site'}</div>
                      </div>
                      <div>
                        <span className="text-sm text-govgray-600">Data de cadastro:</span>
                        <div className="font-medium">{formatDate(selectedLead.data_criacao)}</div>
                      </div>
                      <div>
                        <span className="text-sm text-govgray-600">ID:</span>
                        <div className="font-medium">#{selectedLead.id}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    ...
                    className="bg-govgray-600 hover:bg-govgray-700 text-white px-4 py-2 rounded-lg font-medium transition-colors"
                  >
                    Fechar
                  </button>
                </div>
